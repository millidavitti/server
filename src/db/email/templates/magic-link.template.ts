export function magicLinkEmailTemplate(signInLink: string) {
	return `<!--
...
<style type="text/css">
@media (max-width: 480px) {
.t23,.t28{mso-line-height-alt:0px!important;line-height:0!important;display:none!important}.t24{padding:40px!important}.t26{border-radius:0!important;width:480px!important}.t15,.t9{width:398px!important}
}
</style>
<!--[if !mso]>-->
...
<!--[if mso]>
<td width="600" class="t26" style="background-color:#FFFFFF;border:1px solid #EBEBEB;overflow:hidden;width:600px;border-radius:3px 3px 3px 3px;">
<![endif]-->
<!--[if !mso]>-->
<td class="t26" style="background-color:#FFFFFF;border:1px solid #EBEBEB;overflow:hidden;width:600px;border-radius:3px 3px 3px 3px;">
<!--<![endif]-->
